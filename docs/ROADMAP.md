...
- [x] 📦 Decentralized manifests (`arca-manifest.yaml`)
- [x] 🔗 Git and Local providers
- [x] 🔒 Deterministic locking (`.arca-assets.lock`)
...
---
[Previous: Contribution Guide](./CONTRIBUTING.md) | [Documentation Index](./README.md) | [Next: Code of Conduct](./CODE_OF_CONDUCT.md)
