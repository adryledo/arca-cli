...
- 🗑️ **Domain clutter**: Assets are not part of the domain, but they are included in the project.
...
- 🕵️ **No Traceability**: Losing track of why a specific instruction was changed.
- 🏝️ **Platform Silos**: A "skill" built for one assistant is hard to use in another.
- ⚠️ **Security Risks**: Using unverified assets without integrity checks.
...
3. 🛡️ **Security by Default**: Content-addressable hashing (SHA-256) ensures that what you run is exactly what was published.
